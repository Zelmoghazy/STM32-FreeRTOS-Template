    ...
    */
    ...
    while (xQueueReceiveFromISR(xIntegerQueue, &ulReceivedNumber, &xHigherPriorityTaskWoken) != errQUEUE_EMPTY) {
        /* 
            ...
            pcStrings[] array to select a string (char *) to send on the other queue.
        */
...
int main(void) 
{
    ...
    */
    ...
    /* 
        Create the task that uses a queue to pass integers to 
        the interrupt service routine. The task is created at priority 1. 
    */
